 ...
 */
export const fetchRegimeLatest = (symbol: string, timeframe: string): Promise<RegimeSnapshot> => {
 ...
 */
export const fetchRegimeRange = (params: RegimeSnapshotParams): Promise<RegimeSnapshot[]> => {
 ...
 */
export const fetchRegimeQuantiles = (symbol: string, timeframe: string): Promise<RegimeQuantiles> => {
	return getJSON<RegimeQuantiles>(
 ...
 */
export const fetchRegimeHealth = (
	symbol: string,
	timeframe: string,
 ...
 */
export const fetchRegimeContext = (params: {
	symbol: string
	ltf: string
	htf: string
	signalType?: string
