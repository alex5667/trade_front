		...
		<div className={styles.backgroundWrapper}>
			...
			<div className={styles.svgContainer}>
				<div className={styles.textContainerBoiko}>
					<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 800 300' preserveAspectRatio='xMidYMid meet'>
						<defs>
							<linearGradient id='grad1' x1='0%' y1='0%' x2='100%' y2='100%'>
								<stop offset='0%' stopColor='var(--secondary, #8888ff)' stopOpacity='0.3' />
							...
							<filter id='volume-shadow' x='-50%' y='-50%' width='200%' height='200%'>
